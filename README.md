## Olá, sou Pedro — Desenvolvedor Fullstack
<h3>📌Sobre mim.</h3>
Desenvolvedor Fullstack com foco em criar soluções eficientes e escaláveis.
...
- **Backend:** C# (.NET), Node.js (Express, NestJS), PHP  
- **Frontend:** React, Vite, Material UI  
- **Banco de Dados:** MySQL, PostgreSQL
- **DevOps:** Docker, Serverless, Vercel  
- **Ferramentas:** Git
...
<div> 
  ...
  <a href="https://www.linkedin.com/in/pedrovjesus/" target="_blank"><img src="https://img.shields.io/badge/-LinkedIn-%230077B5?style=for-the-badge&logo=linkedin&logoColor=white" target="_blank"></a> 
</div>
